                ...
                <div class="login-wrap p-4 p-md-5">
                    ...
                    <form method="POST" class="login-form">
                        ...
                        <div class="form-group mb-4">
                            <input type="text" class="form-control rounded-left" name="username" id="username" placeholder="username" value="<?=(isset($_POST['username'])) ? $_POST['username'] : '' ?>" >
                            <?php  if(in_array("username",$error)) echo"Please Enter Name";?>
                        </div>


                        <div class="form-group mb-4">
                            <input type="email" class="form-control rounded-left" name="email" id="email" placeholder="email" value="<?=(isset($_POST['email'])) ? $_POST['email'] : '' ?>">
                        ...
                        <div class="form-group  mb-4">
                            ...
                            <p>
                            <?php if(in_array("password",$error)) echo"Please Enter password not less than 6 characters";?></p>
                        </div>
